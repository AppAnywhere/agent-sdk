...
// WebTunnelAgent.h
//
// $Id: //my-devices.net/Main/gateway/src/WebTunnelAgent.h#1 $
//
...
#ifndef MyDevices_WebTunnelAgent_INCLUDED
#define MyDevices_WebTunnelAgent_INCLUDED
...
#endif // MyDevices_WebTunnelAgent_INCLUDED
