...
// GatewayServer.cpp
//
// $Id: //my-devices.net/Main/gateway/src/GatewayServer.cpp#1 $
//
...
public:
	...
	HTTPRequestHandler* createRequestHandler(const HTTPServerRequest& request)
	{
		...
		else if (uri == "/images/homeicon.png")
			return new HomeIcon;
		else
			return 0;
	}
...
protected:
	...
	void displayHelp()
	{
		...
		helpFormatter.setHeader("\n"
			"my-devices.net WebTunnel Gateway Server.\n"
	...
	int main(const std::vector<std::string>& args)
	{
		...
		Poco::UInt16 port = static_cast<Poco::UInt16>(config().getInt("webserver.port", 8080));
...
POCO_SERVER_MAIN(GatewayServer)
